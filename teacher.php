...
<body>
	...
	<h4>Academics</h4>
    <button onclick="window.location.href='attendance.php'"><img src="337.png" alt="icon"> Attendance</button>
    <button onclick="window.location.href='time_table.html'"><img src="221.png" alt="icon"> Time Table</button>
    <button onclick="window.location.href='upl_marks.html'"><img src="260.png" alt="icon"> Upload Marks</button><br>
    <button onclick="window.location.href='upl_class_diary.php'"><img src="412.png" alt="icon"> Class Diary</button>
	
	<h4>Communications</h4>
    <button onclick="window.location.href='send_notices.php'"><img src="336.png" alt="icon"> Notices</button>
